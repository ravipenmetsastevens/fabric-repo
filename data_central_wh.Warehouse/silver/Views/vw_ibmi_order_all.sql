...
CREATE         VIEW silver.vw_ibmi_order_all
AS
...
FROM [silver].[ibmi_tlb_order]
WHERE tlb_order_load_number NOT IN (SELECT cd_order_load_number FROM [silver].[ibmi_cd_order])
...
SELECT 
    ...
    [order_delivery_code]
FROM [silver].[ibmi_order]
WHERE order_load_number NOT IN (SELECT cd_order_load_number FROM [silver].[ibmi_cd_order])
  AND order_load_number NOT IN (SELECT tlb_order_load_number FROM [silver].[ibmi_tlb_order])