/***************************************************************************************************
Procedure:          dbo.usp_flrk_repair_order_fullrec_silver
...
Description:        Takes the raw data from the bronze lakehouse table for Fleetrock repair orders 
					and splits it into normalized tables
						...
						- Task Parts
Called by:          Fabric  
					Pipeline: Fleetrock\Pipeline\pl_flrk_repair_order_fullrec
...
Usage:              EXEC dbo.usp_flrk_repair_order_fullrec_silver
...
CREATE PROCEDURE [dbo].[usp_flrk_repair_order_fullrec_silver]
AS

-- MASTER REPAIR ORDER

DELETE FROM silver.flrk_repair_order
...
--  REPAIR ORDER TASKS
DELETE FROM silver.flrk_repair_order_task
