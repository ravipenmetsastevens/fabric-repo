...
Description:        Truncate and load of Incremental Order Silver
Called by:          Fabric
					Pipeline: ibmi_incr_order
Affected table(s):  silver.ibmi_incr_order
Usage:              EXEC dbo.[usp_ibmi_incr_order_silver]
...
CREATE     PROCEDURE [dbo].[usp_ibmi_incr_order_silver]
AS

SET NOCOUNT ON

DELETE FROM silver.ibmi_incr_order

INSERT INTO silver.ibmi_incr_order
SELECT
    ...
    , CONVERT(VARCHAR, a.ORCAC)													AS order_customer_phone_area_code
    , CONVERT(VARCHAR, a.ORCPHN)													AS order_customer_phone_number
    , CONVERT(VARCHAR, a.ORRAC)													AS order_consignee_phone_area_code
    , CONVERT(VARCHAR, a.ORRPHN)													AS order_consignee_phone_number
...
--INTO data_central_wh.silver.ibmi_incr_order
FROM data_central_lh.dbo.ibmi_incr_order_bronze a
