/***************************************************************************************************
Procedure:          dbo.usp_create_fact_incr_billing_all
Create Date:        2024-08-13
Author:             Jeremy Shahan
Description:        Combine all billing data into a single fact table
Called by:          Fabric
					Pipeline: pl_ibmi_incr_billing
Affected table(s):  gold.fact_incr_billing_all
Usage:              EXEC dbo.usp_create_fact_incr_billing_all
...
CREATE   PROCEDURE [dbo].[usp_create_fact_incr_billing_all]
AS

--SET NOCOUNT ON
--SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED

DELETE FROM gold.fact_incr_billing_all

INSERT INTO gold.fact_incr_billing_all
