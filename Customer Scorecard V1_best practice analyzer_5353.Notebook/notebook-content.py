...
dataset = "Customer Scorecard V1" # Enter the name or ID of the semantic model
workspace = "data_central_ws" # Enter the workspace name or ID in which the semantic model exists
