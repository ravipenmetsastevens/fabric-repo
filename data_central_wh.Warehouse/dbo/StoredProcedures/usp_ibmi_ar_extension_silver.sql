/***************************************************************************************************
Procedure:          dbo.usp_ibmi_ar_extension_silver
Create Date:        2026-02-20
Author:             Jeremy Shahan
Description:        Truncate and load of AR Extension File to Silver
Called by:          Fabric
					Pipeline: ibmi_ar_extension
Affected table(s):  silver.ibmi_ar_extension
Usage:              EXEC dbo.usp_ibmi_ar_extension_silver
...
CREATE     PROCEDURE [dbo].[usp_ibmi_ar_extension_silver]
AS

SET NOCOUNT ON

DELETE FROM silver.ibmi_ar_extension
...
SELECT 
        CASE
            WHEN LEN(CONVERT(VARCHAR(8),a.ARENDT)) = 8
                ...
                ELSE NULL END                                                                                   AS ar_ext_create_date
	  , CASE 
            ...
            ELSE NULL END												                                        AS ar_ext_create_time     
      ...
      , CASE
            ...
            ELSE NULL END                                                                                       AS ar_ext_invoice_date
      , CASE
            WHEN LEN(a.ARDPDT) = 6
                THEN DATEFROMPARTS('20' + RIGHT(a.ARDPDT,2),LEFT(a.ARDPDT,2),SUBSTRING(a.ARDPDT,3,2))
            ELSE NULL END                                                                                       AS ar_ext_deposit_or_adjustment_date
      ...
      , CASE
            ...
            ELSE NULL END                                                                                       AS ar_ext_dispatch_date
      --, a.ARSTMF
      --, a.ARGSTA
      --, a.ARGLNO
      ...
      , CASE
            WHEN LEN(CONVERT(VARCHAR(8),a.ARCHDT)) = 8
                ...
                ELSE NULL END                                                                                   AS ar_ext_last_change_date
	  , CASE 
            ...
            ELSE NULL END												                                        AS ar_ext_last_change_time     
      ...
      , CASE
            WHEN LEN(CONVERT(VARCHAR(8),a.ARDEDT)) = 8
                ...
                ELSE NULL END                                                                                   AS ar_ext_delete_date
	  , CASE 
            ...
            ELSE NULL END												                                        AS ar_ext_delete_time     
      , TRIM(a.ARDEUS)                                                                                          AS ar_ext_delete_user_code
      , TRIM(a.ARDEPG)                                                                                          AS ar_ext_delete_program_code
--INTO data_central_wh.silver.ibmi_ar_extension
FROM data_central_lh.dbo.ibmi_ar_extension_bronze a