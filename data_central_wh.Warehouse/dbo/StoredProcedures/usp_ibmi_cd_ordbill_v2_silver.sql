/***************************************************************************************************
Procedure:          dbo.usp_ibmi_cd_ordbill_v2_silver
Create Date:        2024-07-25
Author:             Jeremy Shahan
Description:        Truncate and load of CD ORDBILL Silver
Called by:            Azure Data Factory
					Pipeline: ibmi_cd_ordbill_v2
Affected table(s):  silver.ibmi_cd_ordbill_v2
Usage:              EXEC dbo.usp_ibmi_cd_ordbill_v2_silver
...
CREATE PROCEDURE [dbo].[usp_ibmi_cd_ordbill_v2_silver]
AS

SET NOCOUNT ON

DELETE FROM silver.ibmi_cd_ordbill_v2

INSERT INTO silver.ibmi_cd_ordbill_v2
SELECT
...
FROM data_central_lh.dbo.ibmi_cd_ordbill_v2_bronze a
