/***************************************************************************************************
Procedure:          dbo.usp_ibmi_incr_tlb_order_silver
Create Date:        2024-08-22
Author:             Jeremy Shahan
Description:        Truncate and load of Incremental tlb order to  Silver
Called by:          Fabric
					Pipeline: ibmi_incr_tlb_order
Affected table(s):  silver.ibmi_incr_tlb_order
Usage:              EXEC dbo.usp_ibmi_incr_tlb_order_silver
...
CREATE   PROCEDURE [dbo].[usp_ibmi_incr_tlb_order_silver]
AS

SET NOCOUNT ON

DELETE FROM silver.ibmi_incr_tlb_order

INSERT INTO silver.ibmi_incr_tlb_order
SELECT
...
--INTO data_central_wh.silver.ibmi_incr_tlb_order
FROM data_central_lh.dbo.ibmi_incr_tlb_order_bronze a
